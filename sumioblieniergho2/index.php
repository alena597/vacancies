...
<body>
    ...
    <main class="container">
        ...
        <section id="searchAndFiltersSection" class="search-and-filters-enedis">
            <form id="filterForm" class="enedis-search-form">
                <div class="search-input-wrapper">
                    <input type="text" id="globalSearch" name="globalSearch" placeholder="Шукати посаду, відділ..." class="global-search-input">
                ...
                <div class="filter-options-bar">
                    <div class="filter-dropdown">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <button type="button" class="btn-validate" data-filter-type="department">Застосувати</button>
                        </div>
                    </div>
                    ...
                    <div class="filter-dropdown">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <button type="button" class="btn-validate" data-filter-type="level">Застосувати</button>
                        </div>
                    </div>
                    ...
                    <div class="filter-dropdown">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <button type="button" class="btn-validate" data-filter-type="education">Застосувати</button>
                        </div>
                    </div>
                    ...
                    <div class="filter-dropdown">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <button type="button" class="btn-validate" data-filter-type="city">Застосувати</button>
                        </div>
                    </div>
                    ...
                    <div class="filter-dropdown">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <button type="button" class="btn-validate" data-filter-type="salary">Застосувати</button>
                        </div>
                    </div>

                    <div class="filter-reset-button">
                        <button type="reset" class="reset-filters-btn">
                            <span class="reset-icon">✕</span> Скинути фільтри
                        </button>
                    </div>
                </div>
            </form>
        ...
        <section id="selectedFiltersSection" class="selected-filters-section" style="display: none;">
            ...
            <div id="selectedFiltersContainer" class="selected-filters-container">
            </div>
        </section>
